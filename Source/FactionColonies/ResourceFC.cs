...
public class ResourceFC : IExposable {
  ...
  public ResourceFC(string name, string label, double baseProduction,
                    SettlementFC settlement = null, int i = -1) {
    this.name = name;
    this.label = label;
  ...
  public void ExposeData() {
    ...
    Scribe_Values.Look<double>(ref baseProductionMultiplier,
                               "baseProductionMultiplier");
    Scribe_Values.Look<double>(ref endProductionMultiplier,
                               "endProductionMultiplier");
    Scribe_Values.Look<double>(ref amount, "amount");
    Scribe_Collections.Look<ProductionAdditive>(
        ref baseProductionAdditives, "baseProductionAdditives", LookMode.Deep);
    Scribe_Collections.Look<ProductionMultiplier>(ref baseProductionMultipliers,
  ...
  public double baseProductionMultiplier =
      1; // base production modifier for resource
  public double endProductionMultiplier =
      1; // end production modifier for resource
  public List<ProductionAdditive> baseProductionAdditives =
      new List<ProductionAdditive>(); // {ID, Value, Desc}
  public List<ProductionMultiplier> baseProductionMultipliers =
      new List<ProductionMultiplier>(); // {ID, Value, Desc}

...
public class CompPowerEmpire : CompPowerPlant {
  ...
  protected override float DesiredPowerOutput {
    get {
      ...
      if (faction.powerOutput == null ||
          faction.powerOutput.DestroyedOrNull() ||
  ...
  public override IEnumerable<Gizmo> CompGetGizmosExtra() {
    ...
    if (this.parent.Faction == Faction.OfPlayer) {
      yield return new Command_Action{
          action = delegate(){Find.World.GetComponent<FactionFC>().powerOutput =
                                  this.parent;
      Messages.Message("SetAsOutputSuccess".Translate(),

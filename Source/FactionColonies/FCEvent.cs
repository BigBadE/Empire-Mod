    ...
    public static void ProcessEvents(in List<FCEvent> events)
    {
        ...
        for (int i = 0; i < events.Count(); i++)
        {
            ...
            {   //Make custom event functions here
                ...
                else if (temp.def.defName == "constructBuilding")
                {   //Create building
                ...
                else if( temp.def.defName == "captureEnemySettlement" || temp.def.defName == "raidEnemySettlement" || temp.def.defName == "enslaveEnemySettlement")
                {

...
public class SettlementFC : IExposable, ILoadReferenceable
{
    ...
    public bool increaseWorkers(int ResourceID, int numWorkers)
    {
        ...
        } else if (workers + numWorkers <= workersUltraMax && workers + numWorkers >= 0 && returnResourceByInt(ResourceID).assignedWorkers + numWorkers <= workersUltraMax && returnResourceByInt(ResourceID).assignedWorkers + numWorkers >= 0)
        {
            workers += numWorkers;

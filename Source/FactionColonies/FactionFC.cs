...
public class FactionFC : WorldComponent {
  ...
  public List<String> settlementCaravansList =
      new List<string>(); // list of locations caravans already sent to
  ...
  // public ResourceFC research = new ResourceFC("researching", "Researching",
  // 1);
  ...
  public MilitaryCustomizationUtil militaryCustomizationUtil =
      new MilitaryCustomizationUtil();
  ...
  public List<SettlementSoS2Info> createSettlementQueue =
      new List<SettlementSoS2Info>();
  public List<SettlementSoS2Info> deleteSettlementQueue =
      new List<SettlementSoS2Info>();
  ...
  public override void ExposeData() {
    ...
    Scribe_Collections.Look<SettlementFC>(ref settlements, "settlements",
                                          LookMode.Deep);
    Scribe_Collections.Look<FCPolicy>(ref policies, "factionPolicies",
                                      LookMode.Deep);
    Scribe_Collections.Look<FCEvent>(ref events, "events", LookMode.Deep);
    Scribe_Collections.Look<string>(ref settlementCaravansList,
                                    "settlementCaravansList", LookMode.Value);
    Scribe_Collections.Look<FCTraitEffectDef>(ref traits, "traits",
                                              LookMode.Def);
    Scribe_Collections.Look<int>(ref militaryTargets, "militaryTargets",
                                 LookMode.Value);
    ...
    Scribe_Deep.Look<MilitaryCustomizationUtil>(ref militaryCustomizationUtil,
    ...
    Scribe_Values.Look<int>(ref nextMilitaryFireSupportID,
                            "nextMilitaryFireSupportID", 1);
    Scribe_Values.Look<int>(ref nextMercenaryID, "nextMercenaryID", 1);
    Scribe_Values.Look<int>(ref nextMercenarySquadID, "nextMercenarySquadID",
                            1);
    ...
    Scribe_Collections.Look<SettlementSoS2Info>(
        ref createSettlementQueue, "createSettlementQueue", LookMode.Deep);
    Scribe_Collections.Look<SettlementSoS2Info>(
        ref deleteSettlementQueue, "deleteSettlementQueue", LookMode.Deep);

    // Road builder
    Scribe_Deep.Look<FCRoadBuilder>(ref roadBuilder, "roadBuilder");

    // Traits
    Scribe_Values.Look<int>(ref traitMilitaristicTickLastUsedExtraSquad,
                            "traitMilitaristicTickLastUsedExtraSquad");
    Scribe_Values.Look<int>(ref traitPacifistTickLastUsedDiplomat,
                            "traitPacifistTickLastUsedDiplomat");
    Scribe_Values.Look<int>(
        ref traitExpansionistTickLastUsedSettlementFeeReduction,
        "traitExpansionistTickLastUsedSettlementFeeReduction");
    Scribe_Values.Look<bool>(
        ref traitExpansionistBoolCanUseSettlementFeeReduction,
        "traitExpansionistBoolCanUseSettlementReduction");
    Scribe_Values.Look<int>(ref traitFeudalTickLastUsedMercenary,
                            "traitFeudalTickLastUsedMercenary");
    Scribe_Values.Look<bool>(ref traitFeudalBoolCanUseMercenary,
                             "traitFeudalBoolCanUseMercenary");
    Scribe_Values.Look<int>(ref traitMercantileTradeCaravanTickDue,
                            "traitMercantileTradeCaravanTickDue");
    ...
    Scribe_Collections.Look<FCPolicy>(ref factionTraits, "factionTraits",
                                      LookMode.Deep);
  ...
  class disableMilitaryAid {
    static void Postfix(Map map, Faction faction, Pawn negotiator,
                        ref DiaOption __result) {
  ...
  class MercenaryPassToWorld {
    ...
    static bool
    Prefix(Pawn pawn,
           PawnDiscardDecideMode discardMode = PawnDiscardDecideMode.Decide) {
      ...
      if (faction != null && faction.militaryCustomizationUtil != null) {
        if (faction.militaryCustomizationUtil.AllMercenaryPawns != null &&
            faction.militaryCustomizationUtil.AllMercenaryPawns.Contains(
                pawn)) {
          // Don't pass
          // Log.Message("POOf");
          ///*   MercenarySquadFC squad =
          ///faction.militaryCustomizationUtil.returnSquadFromUnit(pawn);
          //   if (squad.DeployedMercenaries.Count == 0 &&
          //   squad.DeployedMercenaryAnimals.Count == 0)
          //   {
  ...
  class PawnGizmos {
    static void Postfix(ref Pawn __instance, ref IEnumerable<Gizmo> __result) {
      ...
      if (__instance.guest != null) {
        if (__instance.guest.IsPrisoner == true &&
            __instance.guest.PrisonerIsSecure == true) {
          Pawn prisoner = __instance;
            ...
            settlementList.Add(new FloatMenuOption(
                settlement.name +
                    ...
                    " - Prisoners: " + settlement.prisonerList.Count(),
                delegate {
                  // disappear colonist
...
class RaidFriendlyStopSettlementFaction {
  static void Postfix(ref IncidentWorker_RaidFriendly __instance,
                      ref bool __result, IncidentParms parms) {
...
class WorldObjectGizmos {
  static void Postfix(ref WorldObject __instance,
    ...
    if (__instance.def.defName == "Settlement") {
      ...
      if (__instance.Faction != fact &&
          __instance.Faction != Find.FactionManager.OfPlayer) {
        ...
        Command_Action actionHostile = new Command_Action{
            defaultLabel = "AttackSettlement".Translate(), defaultDesc = "",
            icon = texLoad.iconMilitary,
            action = delegate{List<FloatMenuOption> list =
                                  new List<FloatMenuOption>();

        if (!worldcomp.hasPolicy(FCPolicyDefOf.isolationist))
          list.Add(
              new FloatMenuOption("CaptureSettlement".Translate(), delegate {
                List<FloatMenuOption> settlementList =
                    new List<FloatMenuOption>();
                  ...
                  if (settlement.isMilitaryValid() == true) {
                    ...
                    settlementList.Add(new FloatMenuOption(
                        settlement.name + " " + "ShortMilitary".Translate() +
                            ...
                            (!settlement.isMilitaryBusySilent()).ToString(),
                        delegate {
                          if (settlement.isMilitaryBusy() == true) {
                            ...
                            // simulateBattleFC.FightBattle(militaryForce.createMilitaryForceFromSettlement(settlement),
                            // militaryForce.createMilitaryForceFromEnemySettlement(faction));
                          }
                        },
                ...
                if (settlementList.Count == 0) {
                  settlementList.Add(new FloatMenuOption(
                      "NoValidMilitaries".Translate(), null));
                }
        ...
        if (worldcomp.hasPolicy(FCPolicyDefOf.authoritarian) &&
          ...
          list.Add(
              new FloatMenuOption("EnslavePopulation".Translate(), delegate {
                List<FloatMenuOption> settlementList =
                    new List<FloatMenuOption>();
    ...
    Command_Action actionPeaceful = new Command_Action{
        defaultLabel = "FCIncreaseRelations".Translate(), defaultDesc = "",
...

{
  if (__instance.Faction == fact) {
    ...
    SettlementFC test = worldcomp.returnSettlementByLocation(
        __instance.Tile, Find.World.info.name);
    // Log.Message(((bool)(test != null)).ToString());
    if (worldcomp
            .returnSettlementByLocation(__instance.Tile, Find.World.info.name)
            .isUnderAttack == true) {
                            ...
                            __result = __result.Concat(new[] { new Command_Action()
                                {
                                    ...
                                    action = delegate
                                    {
                                        ...
                                        {
        List<FloatMenuOption> settlementList = new List<FloatMenuOption>();
        SettlementFC homeSettlement =
            worldcomp.returnSettlementByLocation(tile, evt.planetName);

        settlementList.Add(new FloatMenuOption(
            TranslatorFormattedStringExtensions.Translate(
                "ResetToHomeSettlement",
                homeSettlement.settlementMilitaryLevel),
            delegate {
            ...
            settlementList.Add(new FloatMenuOption(
                ...
                delegate {
                  if (settlement.isMilitaryBusy() == true) {
                    ...
                    MilitaryUtilFC.changeDefendingMilitaryForce(evt,
                                                                settlement);
                  }
                },
                MenuOptionPriority.Default, null, null, 0f, null, null));
...
class MercenaryDied {
  static bool Prefix(Pawn __instance) {
    if (Find.World.GetComponent<FactionFC>()
            .militaryCustomizationUtil.AllMercenaryPawns.Contains(__instance) ==
        true) {
      __instance.SetFaction(FactionColonies.getPlayerColonyFaction());
      MercenarySquadFC squad =
          Find.World.GetComponent<FactionFC>()
              .militaryCustomizationUtil.returnSquadFromUnit(__instance);
      if (squad != null) {
        Mercenary merc = Find.World.GetComponent<FactionFC>()
                             .militaryCustomizationUtil.returnMercenaryFromUnit(
                                 __instance, squad);
        if (merc != null)
...
class MercenaryAnimalDied {
  static bool Prefix(Corpse corpse) {
    if (Find.World.GetComponent<FactionFC>()
            .militaryCustomizationUtil.AllMercenaryPawns.Contains(
                corpse.InnerPawn) == true) {
...
class TryGiveJobFleeAnimal {
  static bool Prefix(Pawn pawn) {
    if (Find.World.GetComponent<FactionFC>()
            .militaryCustomizationUtil.AllMercenaryPawns.Contains(pawn)) {
      return false;
    } else {
      return true;
    }
...
[HarmonyPatch(typeof(SettlementProximityGoodwillUtility),
              "AppendProximityGoodwillOffsets")]
class GoodwillPatch {
  static void Postfix(int tile, List<Pair<Settlement, int>> outOffsets,
                      bool ignoreIfAlreadyMinGoodwill,
...
class GoodwillPatchFunctionsGoodwillAffect {
  static bool Prefix(ref Faction __instance, Faction other, int goodwillChange,
                     bool canSendMessage = true,
                     bool canSendHostilityLetter = true, string reason = null,
                     GlobalTargetInfo? lookTarget = null) {
    if (__instance.def.defName == "PColony" &&
        other == Find.FactionManager.OfPlayer) {
      if (reason == "GoodwillChangedReason_RequestedTrader".Translate()) {
        return false;
      } else if (reason == "GoodwillChangedReason_ReceivedGift".Translate()) {
        return false;
      }
      return true;
    } else {
    ...
    if (member.Faction.def.defName == "PColony" && !wasWorldPawn &&
      ...
      if (!faction.hasPolicy(FCPolicyDefOf.pacifist)) {
        if (dinfo != null &&
          ...
          Messages.Message("DeathOfFactionPawn".Translate(),
          ...
          if (pawn == null || !pawn.RaceProps.Animal ||
              pawn.mindState.mentalStateHandler.CurStateDef !=
            ...
            foreach (SettlementFC settlement in faction.settlements) {
              ...
              settlement.happiness -=
                  ...
                  traitUtilsFC.cycleTraits(new double(),
                   ...
                   dinfo.Value.Instigator.Faction ==
...
class GoodwillPatchFunctionsPlayerTraded {
  static bool Prefix(ref Faction __instance, float marketValueSentByPlayer,
...
class GoodwillPatchFunctionsCapturedPawn {
  static bool Prefix(ref Faction __instance, Pawn member, Faction violator) {
    if (__instance.def.defName == "PColony" &&
        violator == Find.FactionManager.OfPlayer) {
      Messages.Message("CaptureOfFactionPawn".Translate(),
      ...
      foreach (SettlementFC settlement in Find.World.GetComponent<FactionFC>()
        ...
        settlement.unrest +=
            ...
            traitUtilsFC.cycleTraits(new double(), "unrestGainedMultiplier",
                                     settlement.traits, "multiply") *
            traitUtilsFC.cycleTraits(
                new double(), "unrestGainedMultiplier",
        ...
        settlement.happiness -=
            ...
            traitUtilsFC.cycleTraits(new double(), "happinessLostMultiplier",
                                     settlement.traits, "multiply") *
            traitUtilsFC.cycleTraits(
                new double(), "happinessLostMultiplier",
                Find.World.GetComponent<FactionFC>().traits, "multiply");
...
// This gets all patches Empire makes, gets the ones that would crash on Linux,
// and fixes them
static void FixLinuxHarmonyCrash(Harmony harmony) {
  bool WouldCrash(MethodInfo method) {
    ...
    if (bytes == null || bytes.Length == 0 ||
        (bytes.Length == 1 && bytes.First() == 0x2A)) {
      return true;
    }
  ...
  var methods =
      typeof(FactionFC)
          ...
          .SelectMany(t => {
            HarmonyPatch patch = (HarmonyPatch) Attribute.GetCustomAttribute(
                t, typeof(HarmonyPatch));
            MethodInfo[] m = patch.info.declaringType.GetMethods(
  ...
  foreach (MethodInfo i in methods) {
    // Patching methods without any Prefixes/Postfixes before actually patching
    // them fixes it. Idk why
    harmony.Patch(i);
  }
}
...
public FactionFC(World world) : base(world) {
  ...
  if (FactionColonies.checkForMod("Krkr.AndroidTiers") ||
      FactionColonies.checkForMod("Atlas.AndroidTiers")) {
...
public override void WorldComponentTick() {
  ...
  if (firstTick == true) {
    ...
    if (FCf != null) {
      ...
      factionIcon = texLoad.factionIcons.FirstOrFallback(
          obj => obj.name == factionIconPath, texLoad.factionIcons.First());
  ...
  } else if (faction == null && settlements.Count() >= 0 &&
             factionBackup != null) {
  ...
  Reset:
    ...
    foreach (SettlementSoS2Info entry in createSettlementQueue) {
      ...
      if (entry.planetName == Find.World.info.name) {
        ...
        settlement.Name =
            returnSettlementByLocation(settlement.Tile, Find.World.info.name)
                .name;
    ...
    foreach (SettlementSoS2Info entry in deleteSettlementQueue) {
      ...
      if (entry.planetName == Find.World.info.name) {
        ...
        Find.WorldObjects.Remove(
            Find.World.worldObjects.SettlementAt(entry.location));
...
public void TickActions() {
  ...
  if (traitFeudalBoolCanUseMercenary == false &&
      (traitFeudalTickLastUsedMercenary + GenDate.TicksPerSeason) <=
          Find.TickManager.TicksGame) {
    traitFeudalBoolCanUseMercenary = true;
    Find.LetterStack.ReceiveLetter("FCActionAvailable".Translate(),
                                   "FCActionMercenaryRefreshed".Translate(),
                                   LetterDefOf.PositiveEvent);
  }
  // Expansionist
  if (traitExpansionistBoolCanUseSettlementFeeReduction == false &&
      (traitExpansionistTickLastUsedSettlementFeeReduction +
       GenDate.TicksPerYear) <= Find.TickManager.TicksGame) {
    traitExpansionistBoolCanUseSettlementFeeReduction = true;
    Find.LetterStack.ReceiveLetter("FCActionAvailable".Translate(),
                                   "FCActionSettlementFeeReduction".Translate(),
                                   LetterDefOf.PositiveEvent);
  }

  // Mercantile
  if (hasTrait(FCPolicyDefOf.mercantile) &&
      traitMercantileTradeCaravanTickDue <= Find.TickManager.TicksGame) {
    IncidentWorker_TraderCaravanArrival worker =
        new IncidentWorker_TraderCaravanArrival();
    worker.def = IncidentDefOf.TraderCaravanArrival;
    IncidentParms parms = StorytellerUtility.DefaultParmsNow(
        IncidentCategoryDefOf.FactionArrival, this.returnCapitalMap());
    ...
    parms.spawnRotation = Rot4.FromAngleFlat(
        (((Map) parms.target).Center - parms.spawnCenter).AngleFlat);
...
public void TickMecernaries() {
  ...
  if (mercenaryTick > 120) {
    ...
    // foreach (MercenarySquadFC squad in
    // militaryCustomizationUtil.mercenarySquads)
    {
      MercenarySquadFC squad = militaryCustomizationUtil.mercenarySquads[i];
      if (squad.isDeployed) {
        if (squad.DeployedMercenaries.Count > 0 && squad.isDeployed == true &&
            squad.hasLord == false) {
          ...
          Lord lord = LordMaker.MakeNewLord(
              faction,
              new LordJob_AssistColony(
                  faction, squad.DeployedMercenaries[0].pawn.DutyLocation()),
        ...
        if (Find.WindowStack.IsOpen(typeof(EmpireUIMercenaryCommandMenu)) ==
            false) {
...
// Other functions
ResetFireSupport:
  foreach (MilitaryFireSupport fireSupport in militaryCustomizationUtil
               .fireSupport) {
    if (fireSupport.ticksTillEnd <= Find.TickManager.TicksGame) {
      ...
      if (fireSupport.fireSupportType == "fireSupport") {
        if ((fireSupport.timeRunning % 15) == 0 &&
            fireSupport.timeRunning >= fireSupport.startupTime) // 15
        {
          // Log.Message("Boom");
          IntVec3 spawnCenter =
              (from x in GenRadial
                   .RadialCellsAround(fireSupport.location,
                                      fireSupport.accuracy, true)
                       where x.InBounds(fireSupport.map) select x)
                  .RandomElementByWeight(
                      (IntVec3 x) => new SimpleCurve{
                          {new CurvePoint(0f, 1f), true},
                          {new CurvePoint(fireSupport.accuracy, 0.1f),
                           true}}.Evaluate(x.DistanceTo(fireSupport.location)));
          ...
          ThingDef tempDef;
          if (FactionColonies.checkForMod(
                  "CETeam.CombatExtended")) { // if CE is on
            tempDef = fireSupport.expendProjectile();
            Type typeDef = FactionColonies.returnUnknownTypeFromName(
                "CombatExtended.AmmoDef");
            var ammoSetDef =
                typeDef
                    .GetProperty("AmmoSetDefs",
                                 BindingFlags.Public | BindingFlags.Instance)
                    .GetValue(tempDef);
            Type ammoLink = FactionColonies.returnUnknownTypeFromName(
                "CombatExtended.AmmoLink");
            var ammoLinkVar = ammoSetDef.GetType().GetProperty("Item").GetValue(
                ammoSetDef, new object[]{0});
            ...
            // list of ammotypes
            int count = (int) ammoTypes.GetType().GetProperty("Count").GetValue(
                ammoTypes, new object[]{});
            for (int k = 0; k < count; k++) {
              var ammoDefAmmo =
                  ammoTypes.GetType().GetProperty("Item").GetValue(
                      ammoTypes, new object[]{k});
              if (ammoDefAmmo.GetType()
                      .GetField("ammo",
                                BindingFlags.Public | BindingFlags.Instance)
                      .GetValue(ammoDefAmmo)
                      .ToString() == tempDef.defName) {
            ...
            Type type2 = FactionColonies.returnUnknownTypeFromName(
                "CombatExtended.ProjectileCE");
            MethodInfo launch = type2.GetMethod(
                "Launch",
                new Type[]{typeof(Thing), typeof(Vector2), typeof(float),
                           typeof(float), typeof(float), typeof(float),
                           typeof(Thing)});
            MethodInfo getShotAngle = type2.GetMethod(
                "GetShotAngle", BindingFlags.Public | BindingFlags.Static);
            Thing thing = GenSpawn.Spawn(def, fireSupport.sourceLocation, map,
                                         WipeMode.Vanish);

            PropertyInfo gravityProperty =
                type2.GetProperty("GravityFactor", BindingFlags.NonPublic |
                                                       BindingFlags.Instance);

            Vector2 sourceVec = new Vector2(fireSupport.sourceLocation.x,
                                            fireSupport.sourceLocation.z);
            ...
            float gravity =
                (float) gravityProperty.GetValue(thing); // 1.96f * 5;
            ...
            float shotAngle = (float) getShotAngle.Invoke(
                null, BindingFlags.Public | BindingFlags.Static, null,
                new object[]{shotSpeed, magnitude, shotHeight, true, gravity},
                null);

            launch.Invoke(
                thing,
                new object[]{
                    (Thing) FactionColonies.getPlayerColonyFaction().leader,
                    sourceVec, shotAngle, shotRotation, shotHeight, shotSpeed,
                    null});

          } else {
            def = fireSupport.expendProjectile().projectileWhenLoaded;
            Projectile projectile = (Projectile) GenSpawn.Spawn(
                def, fireSupport.sourceLocation, map, WipeMode.Vanish);
...
public void setStartTime() {
  taxTimeDue =
      Find.TickManager.TicksGame + LoadedModManager.GetMod<FactionColoniesMod>()
...
public void updateFaction() {
  ...
  // FactionColonies.getPlayerColonyFaction().def.techLevel =
  // factionDef.techLevel;
  // FactionColonies.getPlayerColonyFaction().def.apparelStuffFilter =
  // factionDef.apparelStuffFilter;
}
...
public void updateTechLevel(ResearchManager researchManager) {
  ...
  if (!medievalOnly &&
      DefDatabase<ResearchProjectDef>.GetNamed("ShipBasics", false) != null &&
      researchManager.GetProgress(
          DefDatabase<ResearchProjectDef>.GetNamed("ShipBasics", false)) ==
          DefDatabase<ResearchProjectDef>.GetNamed("ShipBasics", false).baseCost &&
    ...
    Log.Message("Ultra");
      ...
      !medievalOnly &&
      DefDatabase<ResearchProjectDef>.GetNamed("Fabrication", false) != null &&
      researchManager.GetProgress(
          DefDatabase<ResearchProjectDef>.GetNamed("Fabrication", false)) ==
    ...
    Log.Message("Spacer");
      ...
      !medievalOnly &&
      DefDatabase<ResearchProjectDef>.GetNamed("Electricity", false) != null &&
      researchManager.GetProgress(
          DefDatabase<ResearchProjectDef>.GetNamed("Electricity", false)) ==
    ...
    Log.Message("Industrial");
      ...
      DefDatabase<ResearchProjectDef>.GetNamed("Smithing", false) != null &&
      researchManager.GetProgress(
          DefDatabase<ResearchProjectDef>.GetNamed("Smithing", false)) ==
  ...
  if (playerColonyfaction != null &&
      playerColonyfaction.def.techLevel < techLevel) {
...
public void updateFactionDef(TechLevel tech, ref Faction faction) {
  ...
  case TechLevel.Medieval:
    if (FactionColonies.checkForMod(
      ...
      replacingDef =
          DefDatabase<FactionDef>.GetNamedSilentFail("VFEM_KingdomCivil");
    } else {
  ...
  // Log.Message("3");
  if (replacingDef.backstoryFilters != null &&
      replacingDef.backstoryFilters.Count != 0)
  ...
  if (tech >= TechLevel.Spacer && def.apparelStuffFilter != null) {
    def.apparelStuffFilter.SetAllow(
        DefDatabase<StuffCategoryDef>.GetNamedSilentFail("Synthread"), true);
    def.apparelStuffFilter.SetAllow(
        DefDatabase<StuffCategoryDef>.GetNamedSilentFail("Hyperweave"), true);
    def.apparelStuffFilter.SetAllow(
        DefDatabase<StuffCategoryDef>.GetNamedSilentFail("Plasteel"), true);
  }
...
public bool sendDiplomaticEnvoy(Faction faction) {
  ...
  if (!faction.def.permanentEnemy) {
    if (Find.TickManager.TicksGame >=
        (factionfc.traitPacifistTickLastUsedDiplomat +
      ...
      if (random > 5) {
        ...
        faction.TryAffectGoodwillWith(Find.FactionManager.OfPlayer,
                                      relationImprovement);
        Find.LetterStack.ReceiveLetter(
            "FCRelationImproved".Translate(),
            TranslatorFormattedStringExtensions.Translate(
                "FCRelationImprovedText", faction.Name, relationImprovement),
            LetterDefOf.PositiveEvent);
      } else {
        Find.LetterStack.ReceiveLetter(
            "FCRelationNotImproved".Translate(),
            TranslatorFormattedStringExtensions.Translate(
                "FCFailedToImproveRelationship", faction.Name),
      ...
      Messages.Message(
          TranslatorFormattedStringExtensions.Translate(
              "XDaysToSendDiplomat",
              Math.Round(GenDate.TicksToDays(
                             (factionfc.traitPacifistTickLastUsedDiplomat +
                              GenDate.TicksPerDay * 5) -
                             Find.TickManager.TicksGame),
                         1)),
    ...
    Messages.Message("FCCannotImproveRelationsWithType".Translate(),
                     MessageTypeDefOf.RejectInput);
    return false;
  }
}
...
public void updateAverages() {
  ...
  if (settlements.Count() > 0 &&
      FactionColonies.getPlayerColonyFaction() != null) {
    FactionColonies.getPlayerColonyFaction().TryAffectGoodwillWith(
        Find.FactionManager.OfPlayer,
        (Convert.ToInt32(averageHappiness) -
         FactionColonies.getPlayerColonyFaction().PlayerGoodwill));
  }
}
...
public double getTotalIncome() // return total income of settlements ####MAKE
                               // UPDATE PER HOUR TICK
{
  double income = 0;
  for (int i = 0; i < settlements.Count(); i++) {
    income += settlements [i]
                  .getTotalIncome();
  }
  return income;
}
...
public double
getTotalProfit() // returns total profit (income - upkeep) of all settlements
{
...
public void updateTotalResources() {
  for (int i = 0; i < returnNumberResource(); i++) {
    ...
    for (int k = 0; k < settlements.Count(); k++) {
      resource += (int) settlements [k]
                      .returnResourceByInt(i)
                      .endProduction;
    }
    returnResourceByInt(i).amount = resource;
    // Log.Message(i + " " + returnResourceByInt(i).amount);  //display total
    // resources by type
  }
}
...
public void updateDailyResearch() {
  ...
  if (Find.ResearchManager.currentProj == null && researchPointPool != 0) {
    Messages.Message(TranslatorFormattedStringExtensions.Translate(
                         "NoResearchExpended", Math.Round(researchPointPool)),
                     MessageTypeDefOf.NeutralEvent);
  } else if (researchPointPool != 0 &&
             Find.ResearchManager.currentProj != null) {
    // Log.Message(researchTotal.ToString());
    float neededPoints;
    neededPoints =
        (float) Math.Ceiling(Find.ResearchManager.currentProj.CostApparent -
    ...
    Find.LetterStack.ReceiveLetter(
        ...
        TranslatorFormattedStringExtensions.Translate(
            "ResearchExpended", Math.Round(expendedPoints),
            Find.ResearchManager.currentProj.LabelCap,
    ...
    if (Find.ColonistBar.GetColonistsInOrder().Count > 0) {
      ...
      Find.ResearchManager.ResearchPerformed(
          (float) Math.Ceiling(
              ((1 * Find.ResearchManager.currentProj.CostFactor(
                        pawn.Faction.def.techLevel)) /
               (0.00825 *
                Find.Storyteller.difficultyValues.researchSpeedFactor)) *
              expendedPoints),
          pawn);
      Log.Message(
          "Passed to function: " +
  ...
  if (settlements.Count != 0) // if settlements is not zero
  {
    ...
    foreach (SettlementFC settlement in settlements) {
      ...
      if (hasTrait(FCPolicyDefOf.industrious)) {
        ...
        if (num == 5) {
          trait_Industrious_TaxPercentageBoost =
              1f + ((float)(Rand.RangeInclusive(20, 50)) / 100f);
          Find.LetterStack.ReceiveLetter(
              "FCIdustriousTaxBoost".Translate(),
              TranslatorFormattedStringExtensions.Translate(
                  "FCIndustriousPop", settlement.name,
      ...
      BillFC bill =
          new BillFC(settlement); // Create new bill connected to settlement
      ...
      bill.taxes.silverAmount =
          (float)(Convert.ToInt32(
              (settlement.totalIncome * trait_Industrious_TaxPercentageBoost) -
              settlement.totalUpkeep)) +
          settlement.returnSilverIncome(true);
      Bills.Add(bill);
    ...
    {
      // Messages.Message("TaxesBilled".Translate() + "!",
      // MessageTypeDefOf.PositiveEvent);
      Find.LetterStack.ReceiveLetter(
          "Taxes Billed", "Taxes from your settlements have been billed",
          LetterDefOf.PositiveEvent);
      uiUpdate();

      // Messages.Message(Find.TickManager.TicksGame.ToString(),
      // MessageTypeDefOf.PositiveEvent);
    }

  } else {

    Messages.Message("NoSettlementsToTax".Translate(),
                     MessageTypeDefOf.NeutralEvent);
  }
}
...
public bool addExperienceToFactionLevel(float xp) {
  ...
  while (factionXPCurrent >= factionXPGoal) {
    ...
    factionLevel += 1;
    Find.LetterStack.ReceiveLetter(
        "FCFactionLevelUp".Translate(),
        TranslatorFormattedStringExtensions.Translate(
            "FCFactionLevelUpDesc", this.name, this.factionLevel),
        LetterDefOf.PositiveEvent);
    leveled = true;
...
public void addEvent(FCEvent fcevent) { // Add event to events
  events.Add(fcevent);

  // check if event has a location, if does, add traits to that specific
  // location;
  ...
  } else { // if no specific location then faction wide
    traits.AddRange(fcevent.traits);
  }
}

public bool checkSettlementCaravansList(
    string location) // list of destinations caravans gone to
{
  for (int i = 0; i < settlementCaravansList.Count(); i++) {
    if (location == settlementCaravansList[i] ||
        Find.WorldGrid.IsNeighbor(Convert.ToInt32(location),
...
public ResourceFC returnResource(
    string name) // used to return the correct resource based on string name
{
  if (name == "food") {
    return food;
  }
...
public ResourceFC returnResourceByInt(
    int name) // used to return the correct resource based on string name
{
  if (name == 0) {
    return food;
  }
...
public int returnNumberResource() { return 9; }
...
public void setCapital() {
  if (Find.CurrentMap != null && Find.CurrentMap.IsPlayerHome == true) {
    ...
    Messages.Message(
        TranslatorFormattedStringExtensions.Translate(
            "SetAsFactionCapital", Find.CurrentMap.Parent.LabelCap),
        MessageTypeDefOf.NeutralEvent);
  } else {
    Messages.Message(
...
public int returnSettlementFCIDByLocation(int location, string planetName) {
  for (int i = 0; i < settlements.Count(); i++) {
    if (settlements[i].mapLocation == location &&
        settlements[i].planetName == planetName) {
      return i;
    }
  }
  return -1;
...
public void TaxTick() {
  if (Find.TickManager.TicksGame >=
      taxTimeDue) // taxTimeDue being used as set interval when skipping time
  {
    ...
    { // update events in this order: regular events: tax events.
      ...
      taxTimeDue += LoadedModManager.GetMod<FactionColoniesMod>()
                        .GetSettings<FactionColonies>()
                        .timeBetweenTaxes;
      // Log.Message(Find.TickManager.TicksGame + " vs " + taxTimeDue + " -
      // Taxing");
    }
...
public void resetTraitMercantileCaravanTime() {
  ...
  this.traitMercantileTradeCaravanTickDue =
      Find.TickManager.TicksGame + (int)(days * GenDate.TicksPerDay);
}

public void StatTick() {
  if (Find.TickManager.TicksGame >=
      dailyTimer) // taxTimeDue being used as set interval when skipping time
  {
    ...
    { // update events in this order: regular events: tax events.
      ...
      if (tmpNum <= FactionColonies.randomEventChance &&
        ...
        FCEvent tmpEvt = FCEventMaker.MakeRandomEvent(
            FCEventMaker.returnRandomEvent(), null);
...
public void MilitaryTick() {
  if (Find.TickManager.TicksGame >= militaryTimeDue) {
    if (LoadedModManager.GetMod<FactionColoniesMod>()
                .GetSettings<FactionColonies>()
                .disableHostileMilitaryActions == false &
        Find.TickManager.TicksGame > (timeStart + GenDate.TicksPerSeason)) {
      // if military actions not disabled or game has not passed through the
      // first season Log.Message("Mil Action debug");
      ...
      // Log.Message("Empire - Debug - Military Actions Disabled. Not
      // processing.");
    }
    militaryTimeDue = Find.TickManager.TicksGame +
                      (60000 * LoadedModManager.GetMod<FactionColoniesMod>()
                                   .GetSettings<FactionColonies>()
                                   .minMaxDaysTillMilitaryAction.RandomInRange);
    // Log.Message(militaryTimeDue + " - " + Find.TickManager.TicksGame);
    // Log.Message((militaryTimeDue - Find.TickManager.TicksGame) / 60000 + "
    // days till next military action"); militaryTimeDue =
  }
}

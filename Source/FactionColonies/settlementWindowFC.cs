...
public class settlementWindowFC : Window
{
    ...
    private List<string> buttons = new List<string>() {
        "DeleteSettlement".Translate(), "UpgradeTown".Translate(), "FCSpecialActions".Translate(), "PrisonersMenu".Translate(), "Military".Translate()
    };
                ...
                {   //If click a button button
                    ...
                    if (buttons[i] == "FCSpecialActions".Translate())
                    {
                        ...
                        if (factionfc.hasPolicy(FCPolicyDefOf.authoritarian))
                            list.Add(new FloatMenuOption("FCBuyLoyalty".Translate(), delegate {
                            Find.WindowStack.Add(new FCWindow_Pay_Silver(this.settlement));
                        }));
                    ...
                    {
                        List<FloatMenuOption> list = new List<FloatMenuOption>();
                        list.Add(new FloatMenuOption(TranslatorFormattedStringExtensions.Translate("ToggleAutoDefend", settlement.autoDefend.ToString()), delegate {

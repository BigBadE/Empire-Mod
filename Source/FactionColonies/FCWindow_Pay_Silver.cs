...
public class FCWindow_Pay_Silver : Window {
  ...
  public override Vector2 InitialSize {
    get { return new Vector2(438f, 238f); }
  }
  ...
  public override void DoWindowContents(Rect inRect) {
    ...
    Widgets.Label(label_Upper, TranslatorFormattedStringExtensions.Translate(
                                   "SendingXSilver", selectedSilver));

    selectedSilver = (int) Widgets.HorizontalSlider(slider, selectedSilver, 0,
                                                    silverCount, roundTo : 1);

    Widgets.Label(label_Lower, TranslatorFormattedStringExtensions.Translate(
                                   stringEffect, returnValue(selectedSilver)));

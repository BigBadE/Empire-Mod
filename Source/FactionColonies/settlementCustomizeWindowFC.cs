...
public class settlementCustomizeWindowFC : Window {
  ...
  public override void DoWindowContents(Rect inRect) {
    ...
    for (int i = 0; i < 1; i++) // for each field to customize
    {
      ...
      case 0: // faction name
        Widgets.Label(
            new Rect(xoffset + 3, yoffset + yspacing * i, length / 4, yspacing),
            "SettlementName".Translate() + ": ");
        name = Widgets.TextField(new Rect(xoffset + 3 + length / 4 + 5,
                                          yoffset + yspacing * i, length / 2,
                                          yspacing),
                                 name);
        break;
      ...
      case 1: // faction title
        Widgets.Label(
            new Rect(xoffset + 3, yoffset + yspacing * i, length / 4, yspacing),
            "## title: ");
        title = Widgets.TextField(new Rect(xoffset + 3 + length / 4 + 5,
                                           yoffset + yspacing * i, length / 2,
                                           yspacing),
                                  title);
        break;
      ...
      case 2: // faction icon
        Widgets.Label(
            new Rect(xoffset + 3, yoffset + yspacing * i, length / 4, yspacing),
            "## Icon: ");
        if (Widgets.ButtonImage(new Rect(xoffset + 3 + length / 4 + 5,
                                         yoffset + yspacing * i, 40, 40),
    ...
    if (Widgets.ButtonText(new Rect((InitialSize.x - 120 - 18) / 2,
                                    yoffset + InitialSize.y - 120, 120, 30),
